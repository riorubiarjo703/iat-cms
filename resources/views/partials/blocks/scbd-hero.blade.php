...
<section id="top" class="scbd-pad-top" style="position:relative; min-height:100vh; box-sizing:border-box; display:flex; flex-direction:column; justify-content:space-between; overflow:hidden;">
    <div class="scbd-hero-grid" style="display:grid; grid-template-columns:1fr auto; align-items:end; gap:32px; padding-top:40px;">
        <h1 data-split class="scbd-h1" style="font-size:clamp(52px,9.2vw,168px); line-height:0.88; letter-spacing:-0.045em; margin:0; text-transform:uppercase;" data-i18n="{{ BlockData::i18nKey($blockId, 'heading') }}">{!! nl2br(e($heading)) !!}</h1>

...
return [
     ...
     */
    /*
     * Generated inline rather than queued. This site has no queue worker
     * running, so a queued conversion never happens: the upload appears to
     * succeed, the thumbnail never arrives, and the job sits in the jobs table
     * unnoticed. An editor uploading a handful of images at a time can afford
     * the extra second on the request; a silent failure is worse.
     *
     * Set QUEUE_CONVERSIONS_BY_DEFAULT=true once a worker is supervised.
     */
